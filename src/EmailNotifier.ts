...
import {MailAppType, MailerOptions, Transaction, DraftType} from './Types'
...
class Templates {
  ...
  class EmailNotifier extends Notifier {
    ...
    sendMail_(recipient, message) {
      ...
      this.mailer.sendEmail(recipient, message.subject, message.text, options)
    }
  ...
  /**
    ...
    */
  function getGmailTemplateFromDrafts_(drafts:DraftType[], subject_line:string)  {
    // get drafts
