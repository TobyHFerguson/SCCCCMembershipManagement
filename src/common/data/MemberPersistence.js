...
Common.Data.MemberPersistence = Common.Data.MemberPersistence || {};
 ...
 */
Common.Data.MemberPersistence.writeChangedCells = function(sheet, originalRows, modifiedMembers, headers) {
  let changeCount = 0;
 ...
 */
Common.Data.MemberPersistence.valuesEqual = function(a, b) {
