...
declare namespace Common.Config {
    namespace Properties {
         ...
         */
        function getProperty(propertyName: string, defaultValue?: string): string | null;
         ...
         */
        function getNumberProperty(propertyName: string, defaultValue?: number): number;
         ...
         */
        function getBooleanProperty(propertyName: string, defaultValue?: boolean): boolean;
         ...
         */
        function setCodeInternalProperty(propertyName: string, value: string): void;
         ...
         */
        function deleteCodeInternalProperty(propertyName: string): void;
         ...
         */
        function getAllUserProperties(): { [key: string]: string };
    }
}
