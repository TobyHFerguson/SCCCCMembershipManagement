...
chai.use(sinonChai);
import { Directory, Member, MemberAlreadyExistsError, Notifier, TransactionProcessor } from '../src/Code';
...
describe('TransactionProcessor tests', () => {
  ...
  it('should generate new email addresses when the same name has already been used', () => {
    ...
    stub.addMember.onCall(0).throws(new MemberAlreadyExistsError("member already exists"))
